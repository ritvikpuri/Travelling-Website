	...
	<div class="container">
		...
		<div class="col-md-6 col-xs-12">
			...
			<div class="form-group">
				...
				<div class="row">
					Password: <input type="password" class="form-control" name="password1" required> 
				</div>
				<div class="row">
					Re-enter Password: <input type="password" class="form-control" name="password2" required> 
				</div>
