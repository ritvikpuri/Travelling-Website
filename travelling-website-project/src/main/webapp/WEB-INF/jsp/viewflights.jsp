    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <table class="table table-hover" id="flights">
                ...
                <a href="#" class="btn btn-outline-warning" data-toggle="modal" data-target="#largeModal">Modify
                    Search</a>
                <br><br>
                ...
                <thread>
                    <tr>
                        ...
                        <th onclick="sortTablePrice(6)">Price<br>(per Traveller)</th>
                    </tr>
                </thread>
                ...
                <tbody>
                    <c:forEach items="${flightList}" var="flight">
                        <tr>
                            <td> <a href="selected/${flight.flight_num}">
                                    <c:out value="${flight.flight_num}" /> </a> </td>
                            <td>
                                <c:out value="${flight.airlines}" />
                            </td>
                            <td>
                            ...
                            <td>
                                <fmt:formatDate pattern="HH:mm" type="time" value="${flight.dep_time}" />
                            </td>
                            <td>
                                <fmt:formatDate pattern="HH:mm" type="time" value="${flight.arr_time}" />
                            </td>
                            <td>
                    ...
                    <form action="/book" method="POST">
                        <div class="container">
                            <div class="jumbotron">
                                ...
                                <p class="lead" align="center"> Where would you like to go today?</p>
                                <br>
                                <div class="form-group">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="custom-select" name="departures">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="custom-select" name="arrival">
                                                <option value="mumbai">Mumbai</option>
                                                <option value="delhi">Delhi</option>
                                                <option value="goa">Goa</option>
                                                <option value="lucknow">Lucknow</option>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="economy">
                                                <input type="radio" value="economy" name="travelClass" checked>
                                                <span></span>Economy
                                            </label>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="business">
                                                <input type="radio" value="business" name="travelClass">
                                                <span></span>Business
                                            </label>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="first">
                                                <input type="radio" value="first" name="travelClass">
                                                <span></span>First
                                            </label>
                                        </div>
                                    </div>
