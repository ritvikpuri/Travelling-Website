...
<head>
    ...
    <style>
        body {
            background-image: url("https://cdn2.hubspot.net/hubfs/53/ross-parmly-25230.jpg");
                    ...
                    <div class="jumbotron">
                        ...
                        <div class="form-group">
                            ...
                            <div align="center">
                                ...
                                <button type="button" class='btn btn-outline-danger pull-right' data-toggle="modal"
                                    data-target="#smallModal">Log out</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-cancel" data-dismiss="modal">Close</button>
                    <a href="logout" class="btn btn-outline-danger">Log Out</button>
                </div>
            </div>
        </div>
    </div>
